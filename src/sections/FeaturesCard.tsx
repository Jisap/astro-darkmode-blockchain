...
const cardData = [
  ...
  },
  {
    ...
    description: 'Empower your application with decentralized data solutions, ensuring security and transparency at every step.',
    color: 'lime',
  },
  {
...
export const FeaturesCard = () => {
  return (
    <section className="py-24 overflow-x-clip md:-mt-28">
      <div className=" px-4 md:px-8 mx-auto lg:px-10">
