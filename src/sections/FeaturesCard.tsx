...
const cardData = [
  {
    ...
    title: 'Descentralized Data Solutions',
    description: 'Empower your apllication with decentralized data solutions, ensuring security and transparency ata every step.',
    color: 'lime',
  },
  ,{
