        ...
        <div className="flex flex-col gap-56 md:gap-48 lg:gap-80">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="col-span-2">
              ...
              <p className="text-xl lg:text-2xl text-zinc-400 mt-8">Blockforge provides robust ans secure infraestructure to support the next generation of descentralized applications.</p>
